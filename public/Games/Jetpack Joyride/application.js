System.register([], function (_export, _context) {
  ...
  function onGameStarted(cc, settings) {
	...
	//fast
	/*
	var gOrient = setInterval(function()
	{
		console.log(window.innerWidth, window.innerHeight); //@ts-ignore

		if(window.fast.info.mobile)
		{
			if(window.innerWidth>window.innerHeight)
			{
				clearInterval(gOrient);
				...
				cc.director.loadScene(launchScene, null, function () {
				  cc.view.setDesignResolutionSize(1507, 895, 3);
