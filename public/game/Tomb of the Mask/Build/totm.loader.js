        (function() {
            const SAVE_KEY = "tombofthemask_save";
        ...
        function createUnityInstance(t, n, l) {
            ...
            function r(e) {
                ...
                (n += "\n" + (r = r.startsWith(n) ? r.substring(n.length) : r).trim()) && u.stackTraceRegExp && u.stackTraceRegExp.test(n) && h(n, e.filename || t && (t.fileName || t.sourceURL) || "", e.lineno || t && (t.lineNumber || t.line) || 0)
            }
            ...
            }), window.addEventListener("error", r), window.addEventListener("unhandledrejection", r), u.deinitializers.push(function() {
                for (var e in u.disableAccessToMediaDevices(), i.forEach(function(e) {
                        t.removeEventListener(e, a)
                    }), window.removeEventListener("error", r), window.removeEventListener("unhandledrejection", r), u.intervals) window.clearInterval(e);
                u.intervals = {}
            ...
            var s = "",
                f = "",
                c = (document.addEventListener("webkitfullscreenchange", function(e) {
            ...
            u.SystemInfo = function() {
                ...
                return h(e, "", 0), !0
            }, Error.stackTraceLimit = Math.max(Error.stackTraceLimit || 0, 50), u.readBodyWithProgress = function(i, a, s) {
                    ...
                    function o() {
                        return void 0 === e ? i.arrayBuffer().then(function(e) {
                            ...
                            if (e.done) {
                                ...
                                for (var t = new Uint8Array(c), n = (t.set(f, 0), h), r = 0; r < u.length; ++r) t.set(u[r], n), n += u[r].length;
                                return t
                            }
                    ...
                    require: function(e) {
                        var t, n = {
                            "inflate.js": function(e, t, n) {
                                ...
                                function s(e, t) {
                                    if ((t = new a(t)).push(e, !0), t.err) throw t.msg || r[t.err];
                                    return t.result
                                }
                                a.prototype.push = function(e, t) {
                                    var n, r, o, i, a, s = this.strm,
                                        l = this.options.chunkSize,
                                        d = this.options.dictionary,
                                        f = !1;
                                    if (this.ended) return !1;
                                    r = t === ~~t ? t : !0 === t ? b.Z_FINISH : b.Z_NO_FLUSH, "string" == typeof e ? s.input = h.binstring2buf(e) : "[object ArrayBuffer]" === g.call(e) ? s.input = new Uint8Array(e) : s.input = e, s.next_in = 0, s.avail_in = s.input.length;
                                    do {
                                    ...
                                    } while (!s.next_out || 0 !== s.avail_out && n !== b.Z_STREAM_END && (0 !== s.avail_in || r !== b.Z_FINISH && r !== b.Z_SYNC_FLUSH) || ("string" === this.options.to ? (a = h.utf8border(s.output, s.next_out), o = s.next_out - a, i = h.buf2string(s.output, a), s.next_out = o, s.avail_out = l - o, o && c.arraySet(s.output, s.output, a, o, 0), this.onData(i)) : this.onData(c.shrinkBuf(s.output, s.next_out))), 0 === s.avail_in && 0 === s.avail_out && (f = !0), (0 < s.avail_in || 0 === s.avail_out) && n !== b.Z_STREAM_END);
                                    return (r = n === b.Z_STREAM_END ? b.Z_FINISH : r) === b.Z_FINISH ? (n = u.inflateEnd(this.strm), this.onEnd(n), this.ended = !0, n === b.Z_OK) : r !== b.Z_SYNC_FLUSH || (this.onEnd(b.Z_OK), !(s.avail_out = 0))
                                }, a.prototype.onData = function(e) {
                                    this.chunks.push(e)
                                }, a.prototype.onEnd = function(e) {
                                    e === b.Z_OK && ("string" === this.options.to ? this.result = this.chunks.join("") : this.result = c.flattenChunks(this.chunks)), this.chunks = [], this.err = e, this.msg = this.strm.msg
                                }, n.Inflate = a, n.inflate = s, n.inflateRaw = function(e, t) {
                                ...
                                var r = "undefined" != typeof Uint8Array && "undefined" != typeof Uint16Array && "undefined" != typeof Int32Array,
                                    o = (n.assign = function(e) {
                                        ...
                                        flattenChunks: function(e) {
                                            for (var t, n, r, o = 0, i = 0, a = e.length; i < a; i++) o += e[i].length;
                                            for (r = new Uint8Array(o), i = t = 0, a = e.length; i < a; i++) n = e[i], r.set(n, t), t += n.length;
                                            return r
                                        }
                                    }),
                                    i = {
                            ...
                            "utils/strings.js": function(e, t, n) {
                                ...
                                d[254] = d[254] = 1, n.string2buf = function(e) {
                                    for (var t, n, r, o, i = e.length, a = 0, s = 0; s < i; s++) 55296 == (64512 & (n = e.charCodeAt(s))) && s + 1 < i && 56320 == (64512 & (r = e.charCodeAt(s + 1))) && (n = 65536 + (n - 55296 << 10) + (r - 56320), s++), a += n < 128 ? 1 : n < 2048 ? 2 : n < 65536 ? 3 : 4;
                                    for (t = new l.Buf8(a), s = o = 0; o < a; s++) 55296 == (64512 & (n = e.charCodeAt(s))) && s + 1 < i && 56320 == (64512 & (r = e.charCodeAt(s + 1))) && (n = 65536 + (n - 55296 << 10) + (r - 56320), s++), n < 128 ? t[o++] = n : (n < 2048 ? t[o++] = 192 | n >>> 6 : (n < 65536 ? t[o++] = 224 | n >>> 12 : (t[o++] = 240 | n >>> 18, t[o++] = 128 | n >>> 12 & 63), t[o++] = 128 | n >>> 6 & 63), t[o++] = 128 | 63 & n);
                                    return t
                                    ...
                                    for (var n, r, o = t || e.length, i = new Array(2 * o), a = 0, s = 0; s < o;)
                                        if ((n = e[s++]) < 128) i[a++] = n;
                                        else if (4 < (r = d[n])) i[a++] = 65533, s += r - 1;
                                    else {
                                        for (n &= 2 === r ? 31 : 3 === r ? 15 : 7; 1 < r && s < o;) n = n << 6 | 63 & e[s++], r--;
                                        1 < r ? i[a++] = 65533 : n < 65536 ? i[a++] = n : (n -= 65536, i[a++] = 55296 | n >> 10 & 1023, i[a++] = 56320 | 1023 & n)
                                    }
                                    return f(i, a)
                            ...
                            "zlib/inflate.js": function(e, t, n) {
                                ...
                                function a(e) {
                                    var t;
                                    return e && e.state ? (t = e.state, e.total_in = e.total_out = t.total = 0, e.msg = "", t.wrap && (e.adler = 1 & t.wrap), t.mode = N, t.last = 0, t.havedict = 0, t.dmax = 32768, t.head = null, t.hold = 0, t.bits = 0, t.lencode = t.lendyn = new R.Buf32(r), t.distcode = t.distdyn = new R.Buf32(o), t.sane = 1, t.back = -1, z) : F
                                }
                                ...
                                function l(e, t) {
                                    var n, r;
                                    return !e || !e.state || (r = e.state, t < 0 ? (n = 0, t = -t) : (n = 1 + (t >> 4), t < 48 && (t &= 15)), t && (t < 8 || 15 < t)) ? F : (null !== r.window && r.wbits !== t && (r.window = null), r.wrap = n, r.wbits = t, s(e))
                                }

                                function d(e, t) {
                                    var n;
                                    return e ? (n = new i, (e.state = n).window = null, (n = l(e, t)) !== z && (e.state = null), n) : F
                                }
                                var D, H, W = !0;

                                function j(e, t, n, r) {
                                    var o;
                                    return null === (e = e.state).window && (e.wsize = 1 << e.wbits, e.wnext = 0, e.whave = 0, e.window = new R.Buf8(e.wsize)), r >= e.wsize ? (R.arraySet(e.window, t, n - e.wsize, e.wsize, 0), e.wnext = 0, e.whave = e.wsize) : (r < (o = e.wsize - e.wnext) && (o = r), R.arraySet(e.window, t, n - r, o, e.wnext), (r -= o) ? (R.arraySet(e.window, t, n - r, r, 0), e.wnext = r, e.whave = e.wsize) : (e.wnext += o, e.wnext === e.wsize && (e.wnext = 0), e.whave < e.wsize && (e.whave += o))), 0
                                }
                                n.inflateReset = s, n.inflateReset2 = l, n.inflateResetKeep = a, n.inflateInit = function(e) {
                                    return d(e, 15)
                                }, n.inflateInit2 = d, n.inflate = function(e, t) {
                                    var n, r, o, i, a, s, l, d, f, u, c, h, b, g, m, w, p, v, k, y, _, x, S, E, C = 0,
                                        U = new R.Buf8(4),
                                        B = [16, 17, 18, 0, 8, 7, 9, 6, 10, 5, 11, 4, 12, 3, 13, 2, 14, 1, 15];
                                    if (!e || !e.state || !e.output || !e.input && 0 !== e.avail_in) return F;
                                    12 === (n = e.state).mode && (n.mode = 13), a = e.next_out, o = e.output, l = e.avail_out, i = e.next_in, r = e.input, s = e.avail_in, d = n.hold, f = n.bits, u = s, c = l, x = z;
                                    e: for (;;) switch (n.mode) {
                                        case N:
                                            if (0 === n.wrap) n.mode = 13;
                                                ...
                                                if (2 & n.wrap && 35615 === d) U[n.check = 0] = 255 & d, U[1] = d >>> 8 & 255, n.check = O(n.check, U, 2, 0), f = d = 0, n.mode = 2;
                                                    ...
                                                    if (f -= 4, _ = 8 + (15 & (d >>>= 4)), 0 === n.wbits) n.wbits = _;
                                                    else if (_ > n.wbits) {
                                                        e.msg = "invalid window size", n.mode = 30;
                                                        break
                                                    }
                                                    n.dmax = 1 << _, e.adler = n.check = 1, n.mode = 512 & d ? 10 : 12, f = d = 0
                                                }
                                            }
                                            break;
                                        case 2:
                                            ...
                                            n.head && (n.head.text = d >> 8 & 1), 512 & n.flags && (U[0] = 255 & d, U[1] = d >>> 8 & 255, n.check = O(n.check, U, 2, 0)), f = d = 0, n.mode = 3;
                                        case 3:
                                            for (; f < 32;) {
                                                if (0 === s) break e;
                                                s--, d += r[i++] << f, f += 8
                                            }
                                            n.head && (n.head.time = d), 512 & n.flags && (U[0] = 255 & d, U[1] = d >>> 8 & 255, U[2] = d >>> 16 & 255, U[3] = d >>> 24 & 255, n.check = O(n.check, U, 4, 0)), f = d = 0, n.mode = 4;
                                        case 4:
                                            for (; f < 16;) {
                                                if (0 === s) break e;
                                                s--, d += r[i++] << f, f += 8
                                            }
                                            n.head && (n.head.xflags = 255 & d, n.head.os = d >> 8), 512 & n.flags && (U[0] = 255 & d, U[1] = d >>> 8 & 255, n.check = O(n.check, U, 2, 0)), f = d = 0, n.mode = 5;
                                        case 5:
                                            if (1024 & n.flags) {
                                                for (; f < 16;) {
                                                    if (0 === s) break e;
                                                ...
                                                n.length = d, n.head && (n.head.extra_len = d), 512 & n.flags && (U[0] = 255 & d, U[1] = d >>> 8 & 255, n.check = O(n.check, U, 2, 0)), f = d = 0
                                            } else n.head && (n.head.extra = null);
                                            n.mode = 6;
                                        case 6:
                                            if (1024 & n.flags && ((h = s < (h = n.length) ? s : h) && (n.head && (_ = n.head.extra_len - n.length, n.head.extra || (n.head.extra = new Array(n.head.extra_len)), R.arraySet(n.head.extra, r, i, h, _)), 512 & n.flags && (n.check = O(n.check, r, h, i)), s -= h, i += h, n.length -= h), n.length)) break e;
                                            n.length = 0, n.mode = 7;
                                        case 7:
                                            if (2048 & n.flags) {
                                                if (0 === s) break e;
                                                for (h = 0; _ = r[i + h++], n.head && _ && n.length < 65536 && (n.head.name += String.fromCharCode(_)), _ && h < s;);
                                                if (512 & n.flags && (n.check = O(n.check, r, h, i)), s -= h, i += h, _) break e
                                            } else n.head && (n.head.name = null);
                                            n.length = 0, n.mode = 8;
                                        case 8:
                                            if (4096 & n.flags) {
                                                if (0 === s) break e;
                                                for (h = 0; _ = r[i + h++], n.head && _ && n.length < 65536 && (n.head.comment += String.fromCharCode(_)), _ && h < s;);
                                                if (512 & n.flags && (n.check = O(n.check, r, h, i)), s -= h, i += h, _) break e
                                        ...
                                        case 10:
                                            ...
                                            e.adler = n.check = Z(d), f = d = 0, n.mode = 11;
                                        case 11:
                                            if (0 === n.havedict) return e.next_out = a, e.avail_out = l, e.next_in = i, e.avail_in = s, n.hold = d, n.bits = f, 2;
                                            e.adler = n.check = 1, n.mode = 12;
                                        case 12:
                                            if (5 === t || 6 === t) break e;
                                        case 13:
                                            if (n.last) d >>>= 7 & f, f -= 7 & f, n.mode = 27;
                                            else {
                                                for (; f < 3;) {
                                                    if (0 === s) break e;
                                                    s--, d += r[i++] << f, f += 8
                                                }
                                                switch (n.last = 1 & d, --f, 3 & (d >>>= 1)) {
                                                    case 0:
                                                        n.mode = 14;
                                                        break;
                                                    case 1:
                                                        var L, L = T = void 0,
                                                            T = n;
                                                        if (W) {
                                                            for (D = new R.Buf32(512), H = new R.Buf32(32), L = 0; L < 144;) T.lens[L++] = 8;
                                                            for (; L < 256;) T.lens[L++] = 9;
                                                            for (; L < 280;) T.lens[L++] = 7;
                                                            for (; L < 288;) T.lens[L++] = 8;
                                                            for (P(1, T.lens, 0, 288, D, 0, T.work, {
                                                                    bits: 9
                                                                }), L = 0; L < 32;) T.lens[L++] = 5;
                                                            P(2, T.lens, 0, 32, H, 0, T.work, {
                                                                bits: 5
                                                            }), W = !1
                                                        }
                                                        if (T.lencode = D, T.lenbits = 9, T.distcode = H, T.distbits = 5, n.mode = 20, 6 !== t) break;
                                                        d >>>= 2, f -= 2;
                                                        break e;
                                                    case 2:
                                                        n.mode = 17;
                                        ...
                                        case 14:
                                            ...
                                            if (n.length = 65535 & d, f = d = 0, n.mode = 15, 6 === t) break e;
                                        case 15:
                                            n.mode = 16;
                                        case 16:
                                            if (h = n.length) {
                                                if (0 === (h = l < (h = s < h ? s : h) ? l : h)) break e;
                                                R.arraySet(o, r, i, h, a), s -= h, i += h, l -= h, a += h, n.length -= h
                                            } else n.mode = 12;
                                            break;
                                        case 17:
                                            for (; f < 14;) {
                                        ...
                                        case 18:
                                            for (; n.have < n.ncode;) {
                                                ...
                                                n.lens[B[n.have++]] = 7 & d, d >>>= 3, f -= 3
                                            }
                                            for (; n.have < 19;) n.lens[B[n.have++]] = 0;
                                            if (n.lencode = n.lendyn, n.lenbits = 7, S = {
                                                    bits: n.lenbits
                                                }, x = P(0, n.lens, 0, 19, n.lencode, 0, n.work, S), n.lenbits = S.bits, x) {
                                        ...
                                        case 19:
                                            for (; n.have < n.nlen + n.ndist;) {
                                                for (; w = (C = n.lencode[d & (1 << n.lenbits) - 1]) >>> 16 & 255, p = 65535 & C, !((m = C >>> 24) <= f);) {
                                                    if (0 === s) break e;
                                                    s--, d += r[i++] << f, f += 8
                                                }
                                                if (p < 16) d >>>= m, f -= m, n.lens[n.have++] = p;
                                                else {
                                                    if (16 === p) {
                                                        for (E = m + 2; f < E;) {
                                                            if (0 === s) break e;
                                                        ...
                                                        _ = n.lens[n.have - 1], h = 3 + (3 & d), d >>>= 2, f -= 2
                                                    } else if (17 === p) {
                                                        for (E = m + 3; f < E;) {
                                                            if (0 === s) break e;
                                                            s--, d += r[i++] << f, f += 8
                                                        }
                                                        _ = 0, h = 3 + (7 & (d >>>= m)), d >>>= 3, f = f - m - 3
                                                    } else {
                                                        for (E = m + 7; f < E;) {
                                                            if (0 === s) break e;
                                                            s--, d += r[i++] << f, f += 8
                                                        }
                                                        _ = 0, h = 11 + (127 & (d >>>= m)), d >>>= 7, f = f - m - 7
                                                    }
                                            ...
                                            if (n.lenbits = 9, S = {
                                                    bits: n.lenbits
                                                }, x = P(1, n.lens, 0, n.nlen, n.lencode, 0, n.work, S), n.lenbits = S.bits, x) {
                                                e.msg = "invalid literal/lengths set", n.mode = 30;
                                                break
                                            }
                                            if (n.distbits = 6, n.distcode = n.distdyn, S = {
                                                    bits: n.distbits
                                                }, x = P(2, n.lens, n.nlen, n.ndist, n.distcode, 0, n.work, S), n.distbits = S.bits, x) {
                                        ...
                                        case 21:
                                            if (6 <= s && 258 <= l) {
                                                e.next_out = a, e.avail_out = l, e.next_in = i, e.avail_in = s, n.hold = d, n.bits = f, I(e, c), a = e.next_out, o = e.output, l = e.avail_out, i = e.next_in, r = e.input, s = e.avail_in, d = n.hold, f = n.bits, 12 === n.mode && (n.back = -1);
                                                break
                                            }
                                            for (n.back = 0; w = (C = n.lencode[d & (1 << n.lenbits) - 1]) >>> 16 & 255, p = 65535 & C, !((m = C >>> 24) <= f);) {
                                                if (0 === s) break e;
                                                s--, d += r[i++] << f, f += 8
                                            }
                                            if (w && 0 == (240 & w)) {
                                                for (v = m, k = w, y = p; w = (C = n.lencode[y + ((d & (1 << v + k) - 1) >> v)]) >>> 16 & 255, p = 65535 & C, !(v + (m = C >>> 24) <= f);) {
                                                    if (0 === s) break e;
                                                    s--, d += r[i++] << f, f += 8
                                                }
                                                d >>>= v, f -= v, n.back += v
                                            }
                                            if (d >>>= m, f -= m, n.back += m, n.length = p, 0 === w) {
                                                n.mode = 26;
                                                break
                                            }
                                            if (32 & w) {
                                        ...
                                        case 23:
                                            for (; w = (C = n.distcode[d & (1 << n.distbits) - 1]) >>> 16 & 255, p = 65535 & C, !((m = C >>> 24) <= f);) {
                                                if (0 === s) break e;
                                                s--, d += r[i++] << f, f += 8
                                            }
                                            if (0 == (240 & w)) {
                                                for (v = m, k = w, y = p; w = (C = n.distcode[y + ((d & (1 << v + k) - 1) >> v)]) >>> 16 & 255, p = 65535 & C, !(v + (m = C >>> 24) <= f);) {
                                                    if (0 === s) break e;
                                                    s--, d += r[i++] << f, f += 8
                                                }
                                                d >>>= v, f -= v, n.back += v
                                            }
                                            if (d >>>= m, f -= m, n.back += m, 64 & w) {
                                                e.msg = "invalid distance code", n.mode = 30;
                                                break
                                            }
                                            n.offset = p, n.extra = 15 & w, n.mode = 24;
                                        case 24:
                                            if (n.extra) {
                                                for (E = n.extra; f < E;) {
                                                    if (0 === s) break e;
                                        ...
                                        case 25:
                                            ...
                                            if (n.offset > (h = c - l)) {
                                                ...
                                                b = h > n.wnext ? (h -= n.wnext, n.wsize - h) : n.wnext - h, h > n.length && (h = n.length), g = n.window
                                            } else g = o, b = a - n.offset, h = n.length;
                                            for (l -= h = l < h ? l : h, n.length -= h; o[a++] = g[b++], --h;);
                                        ...
                                        case 27:
                                            if (n.wrap) {
                                                ...
                                                if (c -= l, e.total_out += c, n.total += c, c && (e.adler = n.check = (n.flags ? O : A)(n.check, o, c, a - c)), c = l, (n.flags ? d : Z(d)) !== n.check) {
                                    ...
                                    var n, r = t.length;
                                    return !e || !e.state || 0 !== (n = e.state).wrap && 11 !== n.mode ? F : 11 === n.mode && A(1, t, r, 0) !== n.check ? -3 : j(e, t, r, r) ? (n.mode = 31, -4) : (n.havedict = 1, z)
                            ...
                            "zlib/crc32.js": function(e, t, n) {
                                ...
                                t.exports = function(e, t, n, r) {
                                    var o = s,
                                        i = r + n;
                                    e ^= -1;
                                    for (var a = r; a < i; a++) e = e >>> 8 ^ o[255 & (e ^ t[a])];
                                    return -1 ^ e
                                }
                            },
                            "zlib/inffast.js": function(e, t, n) {
                                ...
                                t.exports = function(e, t) {
                                    var n, r, o, i, a, s, l = e.state,
                                        ...
                                        C = (1 << l.distbits) - 1;
                                    e: do {
                                        for (_ < 15 && (y += f[d++] << _, _ += 8, y += f[d++] << _, _ += 8), n = x[y & E];;) {
                                            if (y >>>= r = n >>> 24, _ -= r, 0 == (r = n >>> 16 & 255)) h[c++] = 65535 & n;
                                            else {
                                                if (!(16 & r)) {
                                                    if (0 == (64 & r)) {
                                                        n = x[(65535 & n) + (y & (1 << r) - 1)];
                                                ...
                                                for (o = 65535 & n, (r &= 15) && (_ < r && (y += f[d++] << _, _ += 8), o += y & (1 << r) - 1, y >>>= r, _ -= r), _ < 15 && (y += f[d++] << _, _ += 8, y += f[d++] << _, _ += 8), n = S[y & C];;) {
                                                    if (y >>>= r = n >>> 24, _ -= r, !(16 & (r = n >>> 16 & 255))) {
                                                        if (0 == (64 & r)) {
                                                            n = S[(65535 & n) + (y & (1 << r) - 1)];
                                                            continue
                                                        }
                                                    ...
                                                    if (i = 65535 & n, _ < (r &= 15) && (y += f[d++] << _, (_ += 8) < r && (y += f[d++] << _, _ += 8)), m < (i += y & (1 << r) - 1)) {
                                    ...
                                    y &= (1 << (_ -= (o = _ >> 3) << 3)) - 1, e.next_in = d -= o, e.next_out = c, e.avail_in = d < u ? u - d + 5 : 5 - (d - u), e.avail_out = c < g ? g - c + 257 : 257 - (c - g), l.hold = y, l.bits = _
                                }
                            },
                            "zlib/inftrees.js": function(e, t, n) {
                                ...
                                t.exports = function(e, t, n, r, o, i, a, s) {
                                    for (var l, d, f, u, c, h, b, g, m, w = s.bits, p = 0, v = 0, k = 0, y = 0, _ = 0, x = 0, S = 0, E = 0, C = 0, U = 0, B = null, L = 0, T = new I.Buf16(16), R = new I.Buf16(16), A = null, O = 0, p = 0; p <= 15; p++) T[p] = 0;
                                    for (v = 0; v < r; v++) T[t[n + v]]++;
                                    for (_ = w, y = 15; 1 <= y && 0 === T[y]; y--);
                                    if (y < _ && (_ = y), 0 === y) o[i++] = 20971520, o[i++] = 20971520, s.bits = 1;
                                    else {
                                        for (k = 1; k < y && 0 === T[k]; k++);
                                        for (_ < k && (_ = k), p = E = 1; p <= 15; p++)
                                            if ((E = (E <<= 1) - T[p]) < 0) return -1;
                                        if (0 < E && (0 === e || 1 !== y)) return -1;
                                        for (R[1] = 0, p = 1; p < 15; p++) R[p + 1] = R[p] + T[p];
                                        for (v = 0; v < r; v++) 0 !== t[n + v] && (a[R[t[n + v]]++] = v);
                                        if (h = 0 === e ? (B = A = a, 19) : 1 === e ? (B = P, L -= 257, A = z, O -= 257, 256) : (B = F, A = N, -1), p = k, c = i, S = v = U = 0, f = -1, u = (C = 1 << (x = _)) - 1, 1 === e && 852 < C || 2 === e && 592 < C) return 1;
                                        for (;;) {
                                            for (m = a[v] < h ? (g = 0, a[v]) : a[v] > h ? (g = A[O + a[v]], B[L + a[v]]) : (g = 96, 0), l = 1 << (b = p - S), k = d = 1 << x; o[c + (U >> S) + (d -= l)] = b << 24 | g << 16 | m | 0, 0 !== d;);
                                            for (l = 1 << p - 1; U & l;) l >>= 1;
                                            if (U = 0 !== l ? (U & l - 1) + l : 0, v++, 0 == --T[p]) {
                                                if (p === y) break;
                                                p = t[n + a[v]]
                                            }
                                            if (_ < p && (U & u) !== f) {
                                                for (c += k, E = 1 << (x = p - (S = 0 === S ? _ : S)); x + S < y && !((E -= T[x + S]) <= 0);) x++, E <<= 1;
                                                if (C += 1 << x, 1 === e && 852 < C || 2 === e && 592 < C) return 1;
                                                o[f = U & u] = _ << 24 | x << 16 | c - i | 0
                                            }
                                        }
                                        0 !== U && (o[c + U] = p - S << 24 | 64 << 16 | 0), s.bits = _
                                    }
                                    return 0
                                }
                            }
                    ...
                    return new Promise(function(i, e) {
                        ...
                        a.src = s, a.onload = function() {
                            if ("undefined" == typeof unityFramework || !unityFramework) {
                                ...
                                d("Unable to parse " + u.frameworkUrl + "! The file is corrupt, or compression was misconfigured? (check Content-Encoding HTTP Response Header on web server)", "error")
                            }
                            var o = unityFramework;
                            unityFramework = null, a.onload = null, URL.revokeObjectURL(s), i(o)
                        }, a.onerror = function(e) {
                            d("Unable to load file " + u.frameworkUrl + "! Check that the file exists on the remote server. (also check browser Console and Devtools Network tab to debug)", "error")
                        }, document.body.appendChild(a), u.deinitializers.push(function() {
                ...
                u.preRun.push(function() {
                    u.addRunDependency("dataUrl"), e.then(function(e) {
                        ...
                        for (n += 4; n < o;) {
                            ...
                            n += s;
                            for (var d = 0, f = l.indexOf("/", d) + 1; 0 < f; d = f, f = l.indexOf("/", d) + 1) u.FS_createPath(l.substring(0, d), l.substring(d, f - 1), !0, !0);
            ...
            return new Promise(function(e, t) {
                u.SystemInfo.hasWebGL ? u.SystemInfo.hasWasm ? (1 == u.SystemInfo.hasWebGL && u.print('Warning: Your browser does not support "WebGL 2" Graphics API, switching to "WebGL 1"'), u.startupErrorHandler = t, l(0), u.postRun.push(function() {
                    l(1), delete u.startupErrorHandler, e(c)
                }), w()) : t("Your browser does not support WebAssembly.") : t("Your browser does not support WebGL.")
            })
        }